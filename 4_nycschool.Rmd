...
### Academic Performance and racial demographics

The correlational analyis above affirms that there is racial inequality in academic performance. How strong is the relationship between academic performance and racial demographics? 

```{r warning=FALSE, message=FALSE}
# Visualize relationship among variables
## For legends
legend <- c("black_per" = "red",
            "white_per" = "blue",
            "asian_per" = "green",
            "hispanic_per" = "purple")
ggplot(survey_complete, aes(y=avg_sat_score)) +
        geom_smooth(aes(x=black_per), color="red") +
        geom_smooth(aes(x=white_per), color="blue") +
        geom_smooth(aes(x=asian_per), color="green") +
        geom_smooth(aes(x=hispanic_per), color="purple") +
        geom_point(aes(x=black_per), color="red", alpha=0.1) +
        geom_point(aes(x=white_per), color="blue", alpha=0.1) +
        geom_point(aes(x=asian_per), color="green", alpha=0.1) +
        geom_point(aes(x=hispanic_per), color="purple", alpha=0.1) +
        theme_minimal() +
